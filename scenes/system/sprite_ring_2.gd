...
func _on_defiler_d_mouse_shape_entered(_shape_idx: int) -> void:
	$defiler_d/coll_ringii_d/button_d.show()
	$defiler.frame = 2

func _on_defiler_d_mouse_shape_exited(_shape_idx: int) -> void:
	$defiler_d/coll_ringii_d/button_d.hide()
	$defiler.frame = 0

func _on_button_d_pressed() -> void:
	if Manager.equip_ring_2 == 0:
		if Manager.iring1 == true:
			Manager.equip_ring_2 = 1
			Manager.iring1 = false
			Manager.iiring1 = false
...
func _process(_delta: float) -> void:
	if Manager.equip_ring_2 == 0:
		...
		$iiring_label.text = "Anneau de respiration en bronze"
	elif Manager.equip_ring_2 == 2:
		$iiring_label.text = "Anneau de respiration en argent"
	elif Manager.equip_ring_2 == 3:
		$iiring_label.text = "Anneau de respiration en or"
	elif Manager.equip_ring_2 == 4:
		$iiring_label.text = "Anneau de vitesse en bronze"
	elif Manager.equip_ring_2 == 5:
		$iiring_label.text = "Anneau de vitesse en argent"
	elif Manager.equip_ring_2 == 6:
		$iiring_label.text = "Anneau de vitesse en or"
	elif Manager.equip_ring_2 == 7:
		$iiring_label.text = "Anneau d'armure en bronze"
	elif Manager.equip_ring_2 == 8:
		$iiring_label.text = "Anneau d'armure en argent"
	elif Manager.equip_ring_2 == 9:
		$iiring_label.text = "Anneau d'armure en or"
	elif Manager.equip_ring_2 == 10:
		$iiring_label.text = "Anneau de force en bronze"
	elif Manager.equip_ring_2 == 11:
		$iiring_label.text = "Anneau de force en argent"
	elif Manager.equip_ring_2 == 12:
		$iiring_label.text = "Anneau de force en or"
	elif Manager.equip_ring_2 == 13:
		$iiring_label.text = "Anneau de vie en bronze"
	elif Manager.equip_ring_2 == 14:
		$iiring_label.text = "Anneau de vie en argent"
	elif Manager.equip_ring_2 == 15:
		$iiring_label.text = "Anneau de vie en or"
