...
func _ouvrir():
	...
	$Tiroir/Tiroir.remove_from_group("ouvrable")
	$Tiroir/Tiroir/Tiroir.remove_from_group("ouvrable")
	$AnimationPlayer.play("ouvrir")
	$Timer.start()

func _on_timer_timeout() -> void:
	self.add_to_group("fouillable")
	$Tiroir/Tiroir.add_to_group("fouillable")
	$Tiroir/Tiroir/Tiroir.add_to_group("fouillable")

func _fouiller():
	self.remove_from_group("fouillable")
	$Tiroir/Tiroir.remove_from_group("fouillable")
...
func _on_inspect_timer_timeout() -> void:
	...
	$Tiroir/Tiroir.add_to_group("vide")
	$Tiroir/Tiroir/Tiroir.add_to_group("vide")
